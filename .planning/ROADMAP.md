...
- [ ] **Phase 1: Frontend Utility and Hardcoded String Cleanup** - Build translateBackendKey utility and remove all hardcoded English strings from frontend page components
...
|-------|----------------|--------|-----------|
| 1. Frontend Utility and Hardcoded String Cleanup | 2/3 | In Progress|  |
