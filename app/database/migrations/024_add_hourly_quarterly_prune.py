...
def upgrade(connection):
    ...
    if columns_added:
        ...
        print(
            "⊘ Migration 024: prune_keep_hourly and prune_keep_quarterly columns already exist, skipping"
        )
...
def downgrade(connection):
    ...
    print(
        "  The prune_keep_hourly and prune_keep_quarterly columns will remain but can be ignored"
    )
    connection.commit()
