...
| 2 | `uninstall.sh` and the uninstall dialog | Implementing ([plan](../plans/2026-09-13-agent-self-service-recovery-phase-2.md)). Gate G1 answered 2026-09-13: test seams accepted, unregister timeout 5s. |
