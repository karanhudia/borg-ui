...
| 4. Fleet upgrade | in review | `docs/engineering/plans/2026-09-10-agent-upgrades-phase-4.md` | `feat/agent-upgrades-phase-4` (PR #997) | Queued endpoints do not age towards the reaper timeout; waves release in id order |
