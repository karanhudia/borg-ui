...
nav_order: 8
description: "Local auth, OIDC SSO, and trusted-header authentication"
---

# Authentication and SSO

Borg UI supports four authentication modes:
...
Local username/password auth is the default.
...
After OIDC works, you can disable local username/password login from the OIDC settings.
