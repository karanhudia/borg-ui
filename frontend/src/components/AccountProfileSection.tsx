    ...
    <Stack spacing={3}>
      ...
      <Box sx={sectionCardSx}>
        ...
        <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
          This is your own identity. It does not change the deployment mode for everyone else.
        </Typography>
        <form
          onSubmit={(e) => {
            e.preventDefault()
      ...
      {canManageSystem && (
        <Box sx={sectionCardSx}>
          ...
          <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
            This is a system-wide setting. It controls how the deployment presents itself for all
            users, independent of your own personal profile.
          </Typography>
          <Box
            sx={{
              display: 'grid',
          ...
          <Box>
            ...
            >
              {isSavingDeployment ? 'Saving deployment' : 'Save deployment profile'}
            </Button>
          </Box>
        </Box>
      )}
