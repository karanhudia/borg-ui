  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
      ...
      {parameters.map((param) => {
        ...
        // e.g., "I Am Var" or "I Am Var (encrypted)" from param name "I_AM_VAR"
        const autoGeneratedPattern = param.name
          .toLowerCase()
          .replace(/_/g, ' ')
          .replace(/\b\w/g, (c: string) => c.toUpperCase())

        const isAutoGenerated =
          param.description === autoGeneratedPattern ||
          param.description === `${autoGeneratedPattern} (encrypted)` ||
          param.description === '' ||
          !param.description
