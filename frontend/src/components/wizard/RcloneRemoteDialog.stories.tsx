...
const providers: RcloneProvider[] = [
  ...
  },
  {
    type: 'dropbox',
    label: 'Dropbox',
    description: 'Dropbox accounts through rclone OAuth.',
    auth_type: 'oauth_token',
    type_editable: false,
    ...
    oauth_mode: 'borg_ui',
    oauth_configured: true,
    oauth_callback_url: 'https://backups.example.com/api/rclone/oauth/callback/dropbox',
    oauth_setup_key: null,
    oauth_credentials_source: 'database',
    oauth_client_id_set: true,
    oauth_client_secret_set: true,
  ...
  },
  {
    type: 'pcloud',
    label: 'Pcloud',
    description: 'Pcloud through rclone OAuth.',
    auth_type: 'oauth_token',
    type_editable: false,
    docs_url: 'https://rclone.org/pcloud/',
    config_template: { type: 'pcloud', token: '' },
    oauth_mode: 'borg_ui',
