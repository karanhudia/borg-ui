...
const base = (overrides: Partial<ActivityItem>): ActivityItem => ({
  ...
  repository_id: 4,
  repository_path: '/local/Users/karanhudia/test-backups/downloads',
...
export const items: ActivityItem[] = [
  base({
    ...
    repository_path: '/local/Users/karanhudia/test-backups/pending',
    status: 'running',
    started_at: at(0, 14, 5),
    completed_at: null,
    progress_percent: 41,
    progress_message: 'Reading /Users/karanhudia/Documents/2026',
  ...
  base({
    ...
    repository_id: 5,
    repository_path: '/local/Users/karanhudia/test-backups/photos',
  ...
  base({
    ...
    repository_path: '/local/Users/karanhudia/test-backups/pending-redundancy',
  ...
  base({
    ...
    repository_path: '/local/Users/karanhudia/test-backups/remote',
    status: 'failed',
    error_message: 'LOCK_ERROR::/local/Users/karanhudia/test-backups/remote',
